...

{
    ...
    home.file = {
        ...
        ".config/zsh/.zshrc".source = ../../dots/zsh/.zshrc;
        ...
        ".config/tmux/tmux.conf".source = ../../dots/tmux/tmux.conf;
        ".config/tmux/plugins/tpm".source = inputs.tmux-tpm;
        ".config/alacritty".source = ../../dots/alacritty;
        ".config/X11".source = ../../dots/X11;
        ".config/bspwm".source = ../../dots/bspwm;
        ".config/picom.conf".source = ../../dots/picom.conf;
        ".config/sxhkd".source = ../../dots/sxhkd;
